package com.example.marketplace.core.data.source.local
...
object DummyData {
    ...
    val listSlider = listOf(
        Slider(id = "1", name = "Slider1", image = R.drawable.asset_slider10),
        Slider(id = "2", name = "Slider2", image = R.drawable.asset_slider11),
        Slider(id = "3", name = "Slider3", image = R.drawable.asset_slider12),
    )
    ...
    val listProduct = listOf(
        ...
        Product(
            id = "9",
            name = "Samsung Galaxy S22 Ultra 5G - Phantom Black",
            harga = 16999000,
